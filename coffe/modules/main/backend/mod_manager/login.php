...
class Login_Module extends Coffe_Module
{
	...
	public function run()
	{
		Coffe::getHead()->addJsFile('_main_login_js', Coffe_ModuleManager::getModuleRelPath('main') . 'backend/login/js/login.js');
		Coffe::getHead()->addCssFile('_main_login_css', Coffe_ModuleManager::getModuleRelPath('main') . 'backend/login/css/login.css');
